...
public class InitMgmtService {
    ...
    /**
     * Initializes if first time setup.
     */
    public void initSym() {
        try {
        ...
        LOGGER.info("It's your first time setup, initializes....");
...
//            tagMgmtService.updateTag(tagId, tag);
            ...
            article.put(Article.ARTICLE_TITLE, "Welcome");
            ...
            LOGGER.info("Initialized, have fun :)");
        } catch (final Exception e) {
            LOGGER.log(Level.ERROR, "Initializes failed", e);
